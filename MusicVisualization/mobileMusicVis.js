...
function init() {
    ...
    if (createjs.Sound.BrowserDetect.isIOS || createjs.Sound.BrowserDetect.isAndroid || createjs.Sound.BrowserDetect.isBlackberry) {
        ...
        document.getElementById("content").style.display = "none";
        displayStatus.addEventListener("click", handleTouch, false);
...
(function() {
    ...
    MyApp.prototype = {
        ...
        init: function() {
            ...
            if(!createjs.Sound.initializeDefaultPlugins()) {
                doucment.getElementById("error").style.display = "block";
                document.getElementById("content").style.display = "none";
                return;
            }

            var assetsPath = "assets/";
            this.nameOfSong = "Harder Better Faster Stronger.mp3";
            this.src = assetsPath+this.nameOfSong;

            this.songName.innerHTML = "Loading mp3...";
            this.artist.innerHTML = "Loading mp3...";

            this.loadProxy = createjs.proxy(this.handleLoad, this);
            createjs.Sound.alternateExtensions = ["mp3"];
            createjs.Sound.onLoadComplete = this.playSound;
            createjs.Sound.addEventListener("fileload", this.playSound);
